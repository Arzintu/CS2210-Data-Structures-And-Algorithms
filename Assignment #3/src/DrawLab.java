...
public class DrawLab extends JFrame{
  ...
  /* ============================= */
    ...
    try {
      ...
      name = "person.gif";
      img = ImageIO.read(new File("C:\\Users\\Owner\\eclipse-workspace\\Assignment #3\\src\\person.gif"));
      name = "personb.gif";
      imgb = ImageIO.read(new File("C:\\Users\\Owner\\eclipse-workspace\\Assignment #3\\src\\personb.gif"));
      name = "rock3.jpg";
      rock = ImageIO.read(new File("C:\\Users\\Owner\\eclipse-workspace\\Assignment #3\\src\\rock3.jpg"));
      drawLabyrinth(input);
    }
