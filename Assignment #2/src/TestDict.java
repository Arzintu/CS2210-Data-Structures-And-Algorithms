...
public class TestDict {
	...
	try {
	    ...
	    System.out.println("Test 6 failed 2");
	}
	...
	try {
	    ...
	    BufferedReader in = new BufferedReader(new FileReader("C:\\Users\\Owner\\eclipse-workspace\\Assignment #2\\src\\large.txt"));
		...
		if (test10) {
		    // Now, try to find the word "practice"
